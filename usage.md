...
<script>const page = "usage"</script>
...
# **Output**
After using the <span class="literal">npc#generate()</span> method, you'll receive an object with all the NPC information inside of it.<br>
